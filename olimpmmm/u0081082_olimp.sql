...
--
-- Хост: localhost
-- Время создания: Сен 25 2015 г., 11:44
...
--
-- База данных: `u0081082_olimp`
--

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_assets`
--

CREATE TABLE IF NOT EXISTS `olmp_assets` (
...
--
-- Дамп данных таблицы `olmp_assets`
--

INSERT INTO `olmp_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 39, 98, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(54, 18, 70, 71, 2, 'com_modules.module.87', 'Логотип', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(55, 18, 72, 73, 2, 'com_modules.module.88', 'Меню', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(56, 18, 74, 75, 2, 'com_modules.module.89', 'Header info', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(57, 18, 76, 77, 2, 'com_modules.module.90', 'Об олимпиаде', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(58, 18, 78, 79, 2, 'com_modules.module.91', 'Результаты 2015', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(59, 18, 80, 81, 2, 'com_modules.module.92', 'Правила', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(60, 18, 82, 83, 2, 'com_modules.module.93', 'Задачи', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(61, 18, 84, 85, 2, 'com_modules.module.94', 'Задачи прошлых лет', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(62, 18, 86, 87, 2, 'com_modules.module.95', 'Эксперты', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(63, 18, 88, 89, 2, 'com_modules.module.96', 'Призы', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(64, 18, 90, 91, 2, 'com_modules.module.97', 'Партнеры и организаторы', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(65, 18, 92, 93, 2, 'com_modules.module.98', 'Промо материалы для партнеров', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(66, 18, 94, 95, 2, 'com_modules.module.99', 'Обратная связь', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(67, 18, 96, 97, 2, 'com_modules.module.100', 'Футер', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}');

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_associations`
--

CREATE TABLE IF NOT EXISTS `olmp_associations` (
...
--
-- Структура таблицы `olmp_banners`
--

CREATE TABLE IF NOT EXISTS `olmp_banners` (
...
--
-- Структура таблицы `olmp_banner_clients`
--

CREATE TABLE IF NOT EXISTS `olmp_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `olmp_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `olmp_banner_tracks` (
...
--
-- Структура таблицы `olmp_categories`
--

CREATE TABLE IF NOT EXISTS `olmp_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `olmp_categories`
--

INSERT INTO `olmp_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Структура таблицы `olmp_contact_details`
--

CREATE TABLE IF NOT EXISTS `olmp_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `olmp_content`
--

CREATE TABLE IF NOT EXISTS `olmp_content` (
...
--
-- Структура таблицы `olmp_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `olmp_contentitem_tag_map` (
...
--
-- Структура таблицы `olmp_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `olmp_content_frontpage` (
...
--
-- Структура таблицы `olmp_content_rating`
--

CREATE TABLE IF NOT EXISTS `olmp_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `olmp_content_types`
--

CREATE TABLE IF NOT EXISTS `olmp_content_types` (
...
--
-- Дамп данных таблицы `olmp_content_types`
--

INSERT INTO `olmp_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `olmp_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `olmp_core_log_searches` (
...
--
-- Структура таблицы `olmp_extensions`
--

CREATE TABLE IF NOT EXISTS `olmp_extensions` (
...
--
-- Дамп данных таблицы `olmp_extensions`
--

INSERT INTO `olmp_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"3dcbae1bd00112a89d490c97fe7df6fa"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `olmp_finder_filters`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_filters` (
...
--
-- Структура таблицы `olmp_finder_links`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links` (
...
--
-- Структура таблицы `olmp_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms0` (
...
--
-- Структура таблицы `olmp_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `olmp_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `olmp_finder_taxonomy`
--

INSERT INTO `olmp_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `olmp_finder_terms`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_terms` (
...
--
-- Структура таблицы `olmp_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `olmp_finder_terms_common`
--

INSERT INTO `olmp_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `olmp_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `olmp_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `olmp_finder_types`
--

CREATE TABLE IF NOT EXISTS `olmp_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `olmp_languages`
--

CREATE TABLE IF NOT EXISTS `olmp_languages` (
...
--
-- Дамп данных таблицы `olmp_languages`
--

INSERT INTO `olmp_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_menu`
--

CREATE TABLE IF NOT EXISTS `olmp_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `olmp_menu`
--

INSERT INTO `olmp_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Дамп данных таблицы `olmp_menu_types`
--

INSERT INTO `olmp_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_messages`
--

CREATE TABLE IF NOT EXISTS `olmp_messages` (
...
--
-- Структура таблицы `olmp_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `olmp_messages_cfg` (
...
--
-- Структура таблицы `olmp_modules`
--

CREATE TABLE IF NOT EXISTS `olmp_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `olmp_modules`
--

INSERT INTO `olmp_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 54, 'Логотип', '', '<img id="logo" src="/templates/jblank/images/logo.png" alt="">', 1, 'header-logo', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(88, 55, 'Меню', '', '<nav class="navigation"> <!-- Navigation -->\r\n                        <ul>\r\n                            <li><a href="#about" class="topnav">Об олимпиаде</a></li>\r\n                            <li><a href="#results" class="topnav">Результаты 2015</a></li>\r\n                            <li><a href="#rules" class="topnav">Правила</a></li>\r\n                            <li><a href="#problems" class="topnav">Задачи</a></li>\r\n                            <li><a href="#experts" class="topnav">Эксперты</a></li>\r\n                            <li><a href="#gifts" class="topnav">Призы</a></li>\r\n                            <li><a href="#partners" class="topnav">Партнеры</a></li>\r\n                            <li><a href="#contact" class="topnav">Обратная связь</a></li>\r\n                        </ul>\r\n                    </nav><!-- Navigation - End -->', 1, 'header-menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(89, 56, 'Header info', '', '<div class="row"> <!-- Row -->\r\n                    <div class="col-md-4"> <!-- col-md-4 -->\r\n                        <img src="/templates/jblank/images/Gyroscope_wired_small_ver_ejcmEn4.png" id="image-header" alt="">\r\n                    </div>\r\n                    <!-- col-md-4 end -->\r\n\r\n                    <div class="col-md-6 col-md-offset-1"> <!-- col-md-6 -->\r\n                        <h2>Международная студенческая олимпиада по механике и математическому моделированию</h2>\r\n\r\n                        <p><span class="grean">Проводится МФТИ совместно с «НПО «Высокоточные комплексы» и доступно из любой точки мира в режиме он-лайн</span></p>\r\n\r\n                        <p>Олимпиада 2015 завершена</p>\r\n                        <a href="#results" class="btn btn-default btn-lg"><p>Посмотреть результаты</p></a>\r\n\r\n                    </div>\r\n                    <!-- col-md-6 end -->\r\n                </div><!-- Row - End -->', 1, 'header-info', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(90, 57, 'Об олимпиаде', '', '<div class="container"> <!-- Container -->\r\n            <h1 class="text-center">Об олимпиаде</h1>\r\n            <hr class="title">\r\n\r\n            <div class="row"> <!-- Row -->\r\n                <div class="col-md-8 col-md-offset-2">\r\n                    <p style="text-align: justify;">&nbsp; <img class="hidden-xs hidden-sm" style="margin-left: 10px; margin-right: 10px; float: right;" src="/templates/jblank/images/about.png" alt="" width="279" height="200" />Московский физико-технический институт и ОАО &laquo;НПО &laquo;Высокоточные комплексы&raquo; организуют открытую международную олимпиаду по механике и математическому моделированию. Принять в ней участие мы предлагаем всем студентам технических вузов и аспирантам технических, математических и естественно-научных направлений.</p>\r\n                    <p style="text-align: justify;">&nbsp; Современный человек в своем повседневном быту привык взаимодействовать с огромным количеством сложных высокотехнологичных систем: мы летаем на самолетах, перемещаемся на метро и сверхскоростных поездах, посещаем экскурсии на катерах с подводными крыльями и слушаем прогнозы погоды, полученные с помощью анализа спутниковых фотоснимков и данных, собранных с тысяч метеостанций. И мы спокойно спим, потому что знаем, что на страже безопасности гражданского населения стоит армия, вооруженная современным высокоточным оружием, способным поразить цель на огромном расстоянии.</p>\r\n                    <p style="text-align: justify;">&nbsp; Редко кто задумывается о том, что за каждым таким продуктом, внутри каждого такого удобного приложения &mdash; лежат сложные математические модели, которые годами формируются и совершенствуются десятками ученых и обсчитываются на огромных вычислительных кластерах. Всякий самолёт и судно на подводных крыльях &mdash; это в первую очередь результат аэро- и гидродинамического моделирования, всякий прогноз погоды берется из модели GFS, которая пересчитывается для всей планеты каждые четыре часа.</p>\r\n                    <p style="text-align: justify;">&nbsp; И есть особенные люди, у которых сложные математические и механические задачи вызывают азарт и желание поскорее отыскать решение, доказать себе и окружающим, что их ум способен вскрыть и показать верные ответы.</p>\r\n                    <p style="text-align: justify;">&nbsp; Именно для таких людей мы организуем пятую по счёту олимпиаду по механике и математическому моделированию. Мы хотим дать возможность лучшим из лучших показать свои навыки и силу своего мышления. И мы хотим показать, что такие навыки востребованы &mdash; как в гражданской, так и в военной промышленности.</p>\r\n                    <p style="text-align: justify;">&nbsp; В этот раз олимпиада будет проводиться в новом онлайн-формате и станет доступна любому, у кого есть мобильный телефон. Для решения задач участникам будет отведена неделя, и все расчёты можно проводить на любых доступных математических пакетах (MatLab, Wolfram Mathematica и др.). Задачи составлены экспертами из МФТИ и институтов РАН, ведущих научную работу в области механики и математического моделирования физических процессов.</p>\r\n                    <p style="text-align: justify;">&nbsp;&nbsp;Победители и авторы лучших решений будут приглашены на итоговую конференцию в Москве и награждены ценными призами.</p>\r\n                </div>\r\n\r\n            </div>\r\n            <!-- Row -->\r\n        </div>\r\n        <!-- Container - End -->', 0, 'about-info', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(91, 58, 'Результаты 2015', '', '<div class="container"> <!-- Container -->\r\n            <h1 class="text-center">Результаты 2015</h1>\r\n            <hr class="title">\r\n\r\n            <div class="row"> <!-- Row -->\r\n                <div class="col-md-8 col-md-offset-2">\r\n                    <p style="text-align: justify;" dir="ltr"><span> &nbsp;&nbsp;Завершилась международная студенческая олимпиада по механике и математическому моделированию. В этом году благодаря использованию нового для России механизма мобильного приложения, через которое участники могли отправлять свои решения, принять участие в олимпиаде смогли около двухсот человек из технических университетов страны, а так же ближнего зарубежья. </span></p>\r\n                    <p style="text-align: justify;" dir="ltr"><span> &nbsp;Участие в организации принял ведущий отечественный военно-промышленный холдинг </span><span>&laquo;НПО &laquo;Высокоточные комплексы&raquo;, руководство которого понимает, как важно для страны поддерживать молодые ученые и кадры в наиболее востребованной и актуальной для индустрии тематике математического моделирования, применяемого к задачам механики.</span></p>\r\n                    <p style="text-align: justify;" dir="ltr"><span> &nbsp;&nbsp;В числе наших партнеров оказалась компания &laquo;Softline&raquo;, являющаяся официальным дистрибьютором компании &laquo;MathWork&raquo;. Партнер предоставил участникам лицензии на математические пакеты &laquo;MatLab&raquo; для удобства расчетов, связанными с решением задач олимпиады. Кроме того, нас поддержали информационно такие известные научно-популярные издания, как &nbsp;&laquo;Популярная механика&raquo; и журнал &laquo;Чердак&raquo;. Так же олимпиаду поддержала Российская ассоциация студентов по развитию науки и образования (РАСНО) и Открытый университет Сколково. </span></p>\r\n                    <p style="text-align: justify;" dir="ltr"><span> &nbsp;Наиболее успешно выступили студенты Московского физико-технического института, Московского государственного университета, а так же Новосибирского. Стоит отметить так же успешные выступления студентов Рязанского радиотехнического университета и Российского химико-технологического университета им. Д.И. Менделеева. Отдельной приятной неожиданностью стало участие аспирантов, в том числе и из института физики твердого тела РАН. </span></p>\r\n                    <p style="text-align: justify;" dir="ltr"><span> &nbsp;Всех участников олимпиады мы приглашаем на итоговую конференцию в МФТИ, которая пройдет осенью. На ней планируется выступление наших партнеров, в том числе руководства &laquo;Высокоточных комплексов&raquo;, представителей науки, института-организатора, а так же торжественное вручение дипломов и сертификатов. Информация о точной дате будет сообщена в рассылке позже.</span><span><br class="kix-line-break" /></span><span> &nbsp;Благодарим всех участников олимпиады, организаторов и партнеров.</span><span><br class="kix-line-break" /><br class="kix-line-break" /></span></p>\r\n                    <h3 style="text-align: center;" dir="ltr"><strong>Моделируй! Изобретай! Побеждай!</strong></h3>\r\n                    <p style="text-align: justify;"><span>&nbsp;</span></p>\r\n                </div>\r\n            </div>\r\n\r\n            <div class="row">\r\n                <div class="col-md-8 col-md-offset-2">\r\n                    <table id="table-style" class="table-hover">\r\n                        <thead>\r\n                        <tr>\r\n                            <th class="col-md-1"></th>\r\n                            <th class="col-md-4"><h5>Участник</h5></th>\r\n                            <th class="col-md-1"><h5>Баллы</h5></th>\r\n                            <th class="col-md-3">\r\n                                <h5>Достижение</h5>\r\n                            </th>\r\n                            <th  class="col-md-2">\r\n                                <h5>Вуз</h5>\r\n                            </th>\r\n                        </tr>\r\n                        </thead>\r\n                        <tbody>\r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_1.png" alt=""></td>\r\n                                <td><h6>Побойко Игорь Валерьевич</h6></td>\r\n                                <td><h6>54</h6></td>\r\n                                <td><h6>Диплом 1-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_2.png" alt=""></td>\r\n                                <td><h6>Синьков Константин Федорович</h6></td>\r\n                                <td><h6>49</h6></td>\r\n                                <td><h6>Диплом 2-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_2.png" alt=""></td>\r\n                                <td><h6>Гусихин Павел Артурович</h6></td>\r\n                                <td><h6>49</h6></td>\r\n                                <td><h6>Диплом 2-й степени</h6></td>\r\n                                <td><h6>ИФТТ РАН</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_2.png" alt=""></td>\r\n                                <td><h6>Степанов Николай Анатольевич</h6></td>\r\n                                <td><h6>49</h6></td>\r\n                                <td><h6>Диплом 2-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_3.png" alt=""></td>\r\n                                <td><h6>Мажник Ефим Анатольевич</h6></td>\r\n                                <td><h6>37</h6></td>\r\n                                <td><h6>Диплом 3-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_3.png" alt=""></td>\r\n                                <td><h6>Астраханцев Никита Юрьевич</h6></td>\r\n                                <td><h6>36</h6></td>\r\n                                <td><h6>Диплом 3-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_3.png" alt=""></td>\r\n                                <td><h6>Нестюк Арсений Павлович</h6></td>\r\n                                <td><h6>33</h6></td>\r\n                                <td><h6>Диплом 3-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_3.png" alt=""></td>\r\n                                <td><h6>Федоряка Дмитрий Сергеевич</h6></td>\r\n                                <td><h6>31</h6></td>\r\n                                <td><h6>Диплом 3-й степени</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_4.png" alt=""></td>\r\n                                <td><h6>Захаров Роман Викторович</h6></td>\r\n                                <td><h6>24</h6></td>\r\n                                <td><h6>Похвальная грамота</h6></td>\r\n                                <td><h6>МГУ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_4.png" alt=""></td>\r\n                                <td><h6>Художитков Александр Эдуардович</h6></td>\r\n                                <td><h6>24</h6></td>\r\n                                <td><h6>Похвальная грамота</h6></td>\r\n                                <td><h6>НГУ</h6></td>\r\n                            </tr>\r\n                        \r\n                            <tr>\r\n                                <td><img src="/templates/jblank/images/medal_4.png" alt=""></td>\r\n                                <td><h6>Федоров Андрей Александрович</h6></td>\r\n                                <td><h6>21</h6></td>\r\n                                <td><h6>Похвальная грамота</h6></td>\r\n                                <td><h6>МФТИ</h6></td>\r\n                            </tr>\r\n                        \r\n                        </tbody>\r\n                    </table>\r\n                </div>\r\n            </div>\r\n            <br>\r\n            <!-- Row -->\r\n            <div class="row"> <!-- Row -->\r\n                <div class="col-md-8 col-md-offset-2">\r\n                    <h6>Проверенные работы и дипломы будут доступны в мобильном приложении.</h6>\r\n                </div>\r\n            </div>\r\n            <br>\r\n\r\n            <div class="row">\r\n                <div class="col-md-8 col-md-offset-3">\r\n                    \r\n                        <div class="col-md-3">\r\n                            <div class="well centered">\r\n                                <a href="/filehost/MMM15-qs.pdf">\r\n                                    <img src="/templates/jblank/images/pdf_icon.png" alt=""><br>\r\n                                    Условия задач\r\n                                </a>\r\n                            </div>\r\n                        </div>\r\n                    \r\n                        <div class="col-md-3">\r\n                            <div class="well centered">\r\n                                <a href="/filehost/tasks_solutions.pdf">\r\n                                    <img src="/templates/jblank/images/pdf_icon.png" alt=""><br>\r\n                                    Решение задач\r\n                                </a>\r\n                            </div>\r\n                        </div>\r\n                    \r\n                        <div class="col-md-3">\r\n                            <div class="well centered">\r\n                                <a href="/filehost/criteria_rating.pdf">\r\n                                    <img src="/templates/jblank/images/doc_icon.png" alt=""><br>\r\n                                    Критерии оценивания\r\n                                </a>\r\n                            </div>\r\n                        </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <!-- Container - End -->', 1, 'results', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(92, 59, 'Правила', '', '<div class="container"> <!-- Container -->\r\n            <h1 class="text-center">Правила</h1>\r\n            <hr class="title">\r\n\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n                <div class="col-md-8">\r\n                    <p style="text-align: justify;"><span>Для участия в олимпиаде Вам потребуется Apple iPhone или смартфон с операционной системой Android. Смартфон необходим для трёх вещей:</span></p>\r\n                    <ul style="text-align: justify;">\r\n                        <li dir="ltr"><span>получения условий задач; </span></li>\r\n                        <li dir="ltr"><span>фотографирования и отправки страниц решения;</span></li>\r\n                        <li dir="ltr"><span>просмотра проверенных решений, результатов и дипломов. </span></li>\r\n                    </ul>\r\n                    <p style="text-align: justify;"><span>Если смартфона на iOS или Android у вас нет, то стоит заранее этим озаботиться &mdash; можно как минимум одолжить его два раза у кого-то из знакомых, друзей или коллег буквально на несколько минут для получения и отправки заданий.&nbsp;</span></p>\r\n\r\n                    <div style="padding:20px 20px 30px 20px; margin-top:20px; margin-bottom: 30px;">\r\n                        <a href="https://play.google.com/store/apps/details?id=su.ias.mfti.olimpiadnik" class="btn btn-default btn-lg"><i class="fa pull-left fa-android"></i>Скачать для Android</a>\r\n                        <a href="https://itunes.apple.com/us/app/olimpiady-mfti/id993211979?l=ru&amp;ls=1&amp;mt=8" class="btn btn-default btn-lg"><i class="fa pull-left fa-apple"></i>Скачать для iOS</a>\r\n                    </div>\r\n\r\n                    <p dir="ltr">Мы рассчитываем на ваш спортивный интерес и честность, и надеемся что вы будете самостоятельно решать задачи.</p>\r\n                    <p dir="ltr">Центр компетенций <a href="http://matlab.ru/">MathWorks</a>&nbsp;предоставляет участникам&nbsp;временную лицензию Matlab для решения задач</p>\r\n                    <p dir="ltr">Для получения лицензии необходимо заполнить <a href="http://goo.gl/forms/VqYXhyW960" target="_blank">форму</a></p>\r\n\r\n                </div>\r\n                <div class="col-md-2"></div>\r\n\r\n            </div>\r\n            <!-- Row - End -->\r\n        </div>\r\n        <!-- Container - End -->', 0, 'rules', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(93, 60, 'Задачи', '', '<div class="container"> <!-- Container -->\r\n            <h1 class="text-center">Задачи</h1>\r\n\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n                <div class="col-md-8">\r\n                    <p class="wow fadeInRight animated" style="visibility: visible; -webkit-animation: fadeInRight; -webkit-animation-play-state: initial; text-align: justify;"><span id="docs-internal-guid-f4a0ae5d-348f-6660-73f7-8e22b97e83ac"><span>Наши эксперты, как и в прошлые годы, подготовили для олимпиады задачи одновременно и сложные и увлекательные: в них есть и математический вызов и интересная содержательная интерпретация. Тематические области задач следующие:</span></span></p>\r\n                    <ul style="text-align: justify;">\r\n                        <li>классическая и прикладная механика</li>\r\n                        <li>гидродинамика</li>\r\n                        <li>вычислительная математика</li>\r\n                        <li>математическое моделирование&nbsp;</li>\r\n                    </ul>\r\n                    <p class="wow fadeInRight animated" style="visibility: visible; -webkit-animation: fadeInRight; -webkit-animation-play-state: initial; text-align: justify;">&nbsp;</p>\r\n                </div>\r\n                <div class="col-md-2"></div>\r\n            </div>\r\n        </div>\r\n        <!-- Container -->', 0, 'tasks', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(94, 61, 'Задачи прошлых лет', '', '<h1 class="text-center">Задачи прошлых лет</h1>\r\n\r\n        <div class="container">\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n                <div class="col-md-8">\r\n                    <p>Ознакомиться с прошлогодними задачами и их решениями вы можете здесь:</p>\r\n                </div>\r\n                <div class="col-md-2"></div>\r\n            </div>\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/problemexample-2013.pdf">\r\n                                <img src="/templates/jblank/images/pdf_icon.png" alt=""><br/>2013 год\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/problemexample-2012.pdf">\r\n                                <img src="/templates/jblank/images/pdf_icon.png" alt=""><br/>2012 год\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/problemexample-2011.pdf">\r\n                                <img src="/templates/jblank/images/pdf_icon.png" alt=""><br/>2011 год\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/problemexample-2010.pdf">\r\n                                <img src="/templates/jblank/images/pdf_icon.png" alt=""><br/>2010 год\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n            </div>\r\n\r\n            <div class="col-xs-2"></div>\r\n\r\n        </div> <!-- Container -->', 0, 'tasks_last', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(95, 62, 'Эксперты', '', '<h1 class="text-center">Эксперты</h1>\r\n\r\n        <div class="container">\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/expert1.jpg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Иванов Александр Павлович</h3>\r\n                        </div>\r\n                        <p class="testi">Доктор физико-математических наук, профессор. Заведующий кафедрой теоретической механики Московского физико-технического института.  Ведущий научный сотрудник сектора Неголономной механики лаборатории «Нелинейного анализа и конструирования новых средств передвижения».</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n            \r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/expert2.jpg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Маркеев Анатолий Павлович</h3>\r\n                        </div>\r\n                        <p class="testi">Доктор физико-математических наук, профессор. Главный научный сотрудник Института проблем механики Российской академии наук. Ведущий научный сотрудник Теоретического сектора лаборатории &quot;Нелинейного анализа и конструирования новых средств передвижения&quot;</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n            \r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/Danil-3-large.jpeg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Иванов Даниил Сергеевич</h3>\r\n                        </div>\r\n                        <p class="testi">Кандидат физико-математических наук, научный сотрудник ИПМ им. М.В. Келдыша РАН. Лектор-ассистент кафедры прикладной математики, факультет управления и прикладной математики МФТИ</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n            \r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/expert3.jpg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Притыкин Дмитрий Аркадьевич</h3>\r\n                        </div>\r\n                        <p class="testi">Кандидат физико-математических наук, доцент кафедры теоретической механики Московского физико-технического института</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n            \r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/240303_original.jpg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Завьялова Наталья Александровна</h3>\r\n                        </div>\r\n                        <p class="testi">Кандидат физико-математических наук, заместитель заведующего кафедрой вычислительной математики МФТИ, заведующая лаборатории моделирования механических систем и процессов МФТИ.</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n            \r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3 centered">\r\n                        <div class="circlete">\r\n                            <img src="/templates/jblank/images/IS_Erofeev.jpg" alt="Profile Picture">\r\n                        </div>\r\n                    </div>\r\n                </div><!-- end row-->\r\n\r\n                <div class="row">\r\n                    <div class="col-md-6 col-md-offset-3">\r\n                        <div class="centered">\r\n                            <h3>Ерофеев Иван Станиславович</h3>\r\n                        </div>\r\n                        <p class="testi">Младший научный сотрудник лаборатории биофизики возбудимых систем МФТИ, преподаватель МФТИ</p>\r\n                    </div>\r\n                </div><!-- end row-->\r\n        </div> <!-- Container - End -->', 0, 'experts', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(96, 63, 'Призы', '', '<div class="container">\r\n            <h1 class="text-center text-dark">Призы</h1>\r\n            <hr class="title">\r\n\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n                <div class="col-md-8">\r\n                    <p>Призеры олимпиады получат сертификаты от МФТИ и возможность встретиться с работодателями из числа наших партнеров на итоговой конференции в Москве.</p>\r\n                </div>\r\n                <div class="col-md-2"></div>\r\n            </div>\r\n\r\n            <div class="row">\r\n                <div class="col-md-2"></div>\r\n                <div class="col-md-8">\r\n                    <p>Победители, кроме того, получат ценные призы.</p>\r\n                </div>\r\n                <div class="col-md-2"></div>\r\n            </div>\r\n        </div>', 0, 'prizes', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(97, 64, 'Партнеры и организаторы', '', '<div class="container">\r\n            <div class="centered">\r\n                <h1>Партнеры и организаторы</h1>\r\n                <hr class="title">\r\n            </div>\r\n            <div class="row" style="margin-top:40px;">\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://mipt.ru" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/rus.jpg" alt="МФТИ">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://www.npovk.ru/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/kompleksi_LIQZtHU.png" alt="АО «НПО «Высокоточные комплексы»">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://danip.ru/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/danip_7wZ8sKp.png" alt="ООО «ДАНИП» ">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://phystech-union.org/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/Fiztekh-Soyuz_t5WYilX.png" alt="Физтез-союз">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://rosobrnauka.ru/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/rasno_mk5PLKI.png" alt="Расно">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://www.popmech.ru/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/pop_mech_c8sQu3R.png" alt="Популярная механика">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://chrdk.ru/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/chrdk_ru_s.png" alt="Чердак">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="http://matlab.ru" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/matlab_logo_MoaZ5YQ.jpg" alt="Mathlab">\r\n                    </a>\r\n                </div>\r\n\r\n                <div class="col-sm-6 col-md-3">\r\n                    <a href="https://sk.ru/opus/" class="thumbnail" target="_blank">\r\n                        <img src="/templates/jblank/images/KAWKAfD8Dgs_UO0LP18.jpg" alt="ОтУС">\r\n                    </a>\r\n                </div>\r\n            </div>\r\n            <!-- Row -->\r\n        </div>\r\n        <!-- Container - End -->', 0, 'partners', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(98, 65, 'Промо материалы для партнеров', '', '<div class="container">\r\n            <div class="centered">\r\n                <h1>Промо материалы для партнеров</h1>\r\n                <hr class="title">\r\n            </div>\r\n            <div class="row">\r\n                <div class="col-md-3"></div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/A3__not_mfti_l.png">\r\n                                <img src="/templates/jblank/images/img_icon.png" alt=""><br/>Афиша А3\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/A3__not_mfti_bw_l.png">\r\n                                <img src="/templates/jblank/images/img_icon.png" alt=""><br/>Афиша А3 Ч/Б\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class="col-md-2">\r\n                        <div class="well centered">\r\n                            <a href="/filehost/МММ-олимпиада-_Анонс_для_разных_групп_в_соцмедиях.docx">\r\n                                <img src="/templates/jblank/images/doc_icon.png" alt=""><br/>Анонс\r\n                            </a>\r\n                        </div>\r\n                    </div>\r\n            </div>\r\n            <div class="col-xs-2"></div>\r\n        </div> <!-- Container -->', 1, 'promo', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');
INSERT INTO `olmp_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(99, 66, 'Обратная связь', '', '<div class="container"> <!-- Container -->\r\n            <h1 class="text-center text-dark wow zoomIn">Обратная связь</h1>\r\n            <hr class="title">\r\n\r\n            <div class="row">\r\n                <div class="col-xs-3"></div>\r\n                <div class="col-md-6 wow fadeInLeft">\r\n                    <form method="post" id="contactForm" action="#">\r\n                        <div class="centered">\r\n                            <h3 class="text-dark">Задайте вопрос об олимпиаде</h3>\r\n                        </div>\r\n                        <input type="text" class="form-control" id="client_name" name="client_name" placeholder="Имя" required>\r\n                        <input type="email" class="form-control" id="client_email" name="client_email" placeholder="E-mail" required>\r\n                        <textarea class="form-control" rows="6" id="client_comment" name="client_comment" placeholder="Ваш вопрос или комментарий..." required></textarea>\r\n                        <div class="centered">\r\n                            <div id="order_status"></div>\r\n                            <button type="submit" id="sendOrderButton" class="btn btn-default btn-lg">Отправить</button>\r\n                            <p>Мы перезвоним вам в течение 1 часа после отправки заявки<br>(в рабочее время с 9:00 до 19:00 мск)</p>\r\n                        </div>\r\n                    </form>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <!-- Container - End -->\r\n        <br>', 1, 'feedback', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(100, 67, 'Футер', '', '<div class="container"> <!-- Container -->\r\n            <div class="row">\r\n                <div class="col-md-5">\r\n                    <a href="https://play.google.com/store/apps/details?id=su.ias.mfti.olimpiadnik" class="btn btn-default btn-lg"><i class="fa pull-left fa-android"></i>Скачать для Android</a>\r\n                    <a href="https://itunes.apple.com/us/app/olimpiady-mfti/id993211979?l=ru&amp;ls=1&amp;mt=8" class="btn btn-default btn-lg"><i class="fa pull-left fa-apple"></i>Скачать для iOS</a>\r\n                </div>\r\n                <div class="col-md-7">\r\n                    <p>&copy; 2015 Международная студенческая олимпиада по механике и математическому моделированию. </p>\r\n                    <p>Служба поддержки <a href="mailto:support@olimpmmm.ru">support@olimpmmm.ru</a></p>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <!-- Container - End -->\r\n        <br>', 0, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_modules_menu`
--

CREATE TABLE IF NOT EXISTS `olmp_modules_menu` (
...
--
-- Дамп данных таблицы `olmp_modules_menu`
--

INSERT INTO `olmp_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `olmp_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `olmp_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `olmp_overrider`
--

CREATE TABLE IF NOT EXISTS `olmp_overrider` (
...
--
-- Структура таблицы `olmp_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `olmp_postinstall_messages` (
...
--
-- Дамп данных таблицы `olmp_postinstall_messages`
--

INSERT INTO `olmp_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `olmp_redirect_links`
--

CREATE TABLE IF NOT EXISTS `olmp_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `olmp_schemas`
--

CREATE TABLE IF NOT EXISTS `olmp_schemas` (
...
--
-- Дамп данных таблицы `olmp_schemas`
--

INSERT INTO `olmp_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_session`
--

CREATE TABLE IF NOT EXISTS `olmp_session` (
...
--
-- Дамп данных таблицы `olmp_session`
--

INSERT INTO `olmp_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('36266ad0c4756a2801fcde3c04a960fe', 0, 1, '1443170360', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1443170360;s:18:"session.timer.last";i:1443170360;s:17:"session.timer.now";i:1443170360;s:24:"session.client.forwarded";s:12:"37.53.48.122";s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.99 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, ''),
('d3007af27929c05877b519d10d487a43', 1, 0, '1443170308', '__default|a:9:{s:15:"session.counter";i:78;s:19:"session.timer.start";i:1443103167;s:18:"session.timer.last";i:1443170308;s:17:"session.timer.now";i:1443170308;s:24:"session.client.forwarded";s:12:"37.53.48.122";s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.99 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":8:{s:18:"client_id_previous";i:0;s:6:"search";s:0:"";s:6:"access";i:0;s:5:"state";s:0:"";s:8:"position";s:0:"";s:6:"module";s:0:"";s:9:"client_id";i:0;s:8:"language";s:0:"";}s:8:"ordercol";s:4:"a.id";s:9:"orderdirn";s:3:"asc";s:10:"limitstart";s:1:"0";}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"484";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:12:"reg@lubus.ru";s:8:"password";s:60:"$2y$10$LqaCahWnrmZD9acHo1axQeskqyMV298z4WrdWVzmJk6joxHq9gbbO";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-09-22 08:51:37";s:13:"lastvisitDate";s:19:"2015-09-24 12:51:18";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"a289a05a67570f44100b809bdcef90d1";}', 484, 'admin');

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_tags`
--

CREATE TABLE IF NOT EXISTS `olmp_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `olmp_tags`
--

INSERT INTO `olmp_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Структура таблицы `olmp_template_styles`
--

CREATE TABLE IF NOT EXISTS `olmp_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `olmp_template_styles`
--

INSERT INTO `olmp_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `olmp_ucm_base`
--

CREATE TABLE IF NOT EXISTS `olmp_ucm_base` (
...
--
-- Структура таблицы `olmp_ucm_content`
--

CREATE TABLE IF NOT EXISTS `olmp_ucm_content` (
...
--
-- Структура таблицы `olmp_ucm_history`
--

CREATE TABLE IF NOT EXISTS `olmp_ucm_history` (
...
--
-- Структура таблицы `olmp_updates`
--

CREATE TABLE IF NOT EXISTS `olmp_updates` (
...
--
-- Структура таблицы `olmp_update_sites`
--

CREATE TABLE IF NOT EXISTS `olmp_update_sites` (
...
--
-- Дамп данных таблицы `olmp_update_sites`
--

INSERT INTO `olmp_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1443094883, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1443094883, ''),
...
--
-- Структура таблицы `olmp_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `olmp_update_sites_extensions` (
...
--
-- Дамп данных таблицы `olmp_update_sites_extensions`
--

INSERT INTO `olmp_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Структура таблицы `olmp_usergroups`
--

CREATE TABLE IF NOT EXISTS `olmp_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `olmp_usergroups`
--

INSERT INTO `olmp_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `olmp_users`
--

CREATE TABLE IF NOT EXISTS `olmp_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `olmp_users`
--

INSERT INTO `olmp_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(484, 'Super User', 'admin', 'reg@lubus.ru', '$2y$10$LqaCahWnrmZD9acHo1axQeskqyMV298z4WrdWVzmJk6joxHq9gbbO', 0, 1, '2015-09-22 08:51:37', '2015-09-24 13:59:44', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_user_keys`
--

CREATE TABLE IF NOT EXISTS `olmp_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `olmp_user_notes`
--

CREATE TABLE IF NOT EXISTS `olmp_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `olmp_user_profiles`
--

CREATE TABLE IF NOT EXISTS `olmp_user_profiles` (
...
--
-- Структура таблицы `olmp_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `olmp_user_usergroup_map` (
...
--
-- Дамп данных таблицы `olmp_user_usergroup_map`
--

INSERT INTO `olmp_user_usergroup_map` (`user_id`, `group_id`) VALUES
(484, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `olmp_viewlevels`
--

CREATE TABLE IF NOT EXISTS `olmp_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `olmp_viewlevels`
--

INSERT INTO `olmp_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
